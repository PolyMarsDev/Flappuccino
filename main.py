...
def main():
    ...
    title_bg.fill(
        (255, 30.599999999999998, 0.0), special_flags=pygame.BLEND_ADD
    )
    ...
    while True:
        ...
        for bean in beans:
            DISPLAY.blit(
                bean.sprite, (bean.position.x, bean.position.y + camOffset)
            )
        ...
        pygame.draw.rect(
            DISPLAY, (81, 48, 20), (21, 437, 150 * (health / 100), 25)
        )
        ...
        for bean in beans:
            ...
            if checkCollisions(
                ...
                beanCount += 1
                health = 100
                bean.position.y -= DISPLAY.get_height() - random.randrange(
                    0, 200
                )
                bean.position.x = random.randrange(
                    0, DISPLAY.get_width() - bean.sprite.get_width()
        ...
        bg[0].position = (
            camOffset
            + round(player.position.y / DISPLAY.get_height())
            * DISPLAY.get_height()
        )
